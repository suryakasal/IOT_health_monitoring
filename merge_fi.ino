...
float reading; //declare variable in which temperature data is storedint x,y;
int count =0;
int x,y;
float calories;
...
void setup()
{
  ...
  interruptSetup();                 // sets up to read Pulse Sensor signal every 2mS 
   ...
   pinMode(A1, INPUT); // Tell Arduino to make its Analog A1 pin as Input reading pin
  // start the serial connection at 9600 bps:
   Serial.begin(9600);
   // initialize serial communication at 9600 bits per second:
   pinMode(A2, INPUT);//for emg
  Serial.begin(9600);
...
void loop()
{
   // read the input on analog pin 2:
    int sensorValue = analogRead(A2)-430;
   // print out the value you read:
    delay(60000);
    Serial.println("the output of emg sensor is:");
    ...
    //delay(60); // 1 min delay before taking the new reading
    x = analogRead(A4);
    y = analogRead(A5);
    x=x-720;
    y=y-720;
